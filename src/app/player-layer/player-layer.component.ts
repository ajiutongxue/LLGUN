...
export class PlayerLayerComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        // console.log(`scrollbar outerwidth: ${this.$scrollbar.outerWidth()}, width: ${this.$scrollbar.width()}`);
        // this.scrollbarOffsetLeft = parseInt(this.$scrollbar.css('left'), 10);
        ...
        // Object.defineProperties(this, 'isShowPic', {
        //     get: function () {
        //         return 1;
        //     },
        //     set: function (value) {
        ...
        // console.log(`init show duration: ${this.shownDuration}`);
        ...
        // console.log(`unit length: ${this.unitLength},  unit duration: ${this.unitDuration}`);
    }

...
import { DragDropService, isPresent, createImage, isString, callFun, isFunction } from './sort-table.service';
...
export abstract class AbstractComponent {
    ...
    constructor(elemRef: ElementRef, public _dragDropService: DragDropService, public _config: DragDropConfig,
        ...
        this._defaultCursor = _config.dragCursor;
